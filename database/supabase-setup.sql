...
INSERT INTO discount_code (code, description, minimum_spend, percent_off, amount_off, active, max_redemptions, seller_id, created_by_seller) VALUES
('WELCOME100', '₱100 off for orders with ₱800 minimum spend.', 800, 0, 100, true, 0, 2, 'Local Goods PH'),
('GREEN5', '5% off for green checkout buyers.', 500, 5, 0, true, 0, 3, 'EcoHome Essentials'),
('LOCAL50', '₱50 off selected local Filipino products.', 300, 0, 50, true, 0, 2, 'Local Goods PH');
