...
public class DataSeeder {
    ...
    private void seedCommunityEssentialsAndSustainableGoods(ProductRepository repo, Seller daily, Seller pantry, Seller eco, Seller local) {
        ...
        baseIfMissing(repo,"Drinking Water Refill Voucher",ProductCategory.GROCERIES,75,daily,"https://images.unsplash.com/photo-1523362628745-0c100150b504?auto=format&fit=crop&w=900&q=80",true,false,"Demo voucher for refillable drinking water access in local communities.","Refill-first household essential");
        ...
        baseIfMissing(repo,"Compost Starter Kit",ProductCategory.SUSTAINABLE_PRODUCTS,349,eco,"https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?auto=format&fit=crop&w=900&q=80",false,false,"Starter kit for household composting and waste reduction demos.","Waste reduction starter kit");
    ...
    private void seedToneMatchFashion(ProductRepository repo, Seller seller) {
        baseIfMissing(repo,"Spring Warm Coral Top",ProductCategory.FASHION,389,seller,"/img/tryon/women-eco-top.svg",false,false,"ToneMatch Korean color analysis: Spring Warm. Best for peach, coral, ivory, light yellow, and warm beige clothing palettes.","ToneMatch: Spring Warm");
        baseIfMissing(repo,"Spring Warm Ivory Shirt",ProductCategory.FASHION,349,seller,"/img/tryon/men-eco-shirt.svg",false,false,"ToneMatch Korean color analysis: Spring Warm. Recommended for clear warm and bright clothing colors.","ToneMatch: Spring Warm");
        baseIfMissing(repo,"Summer Cool Lavender Blouse",ProductCategory.FASHION,429,seller,"/img/tryon/women-white-blouse.svg",false,false,"ToneMatch Korean color analysis: Summer Cool. Best for lavender, powder blue, soft pink, cool gray, and pearl white.","ToneMatch: Summer Cool");
        baseIfMissing(repo,"Summer Cool Powder Blue Cardigan",ProductCategory.FASHION,499,seller,"/img/tryon/women-cardigan.svg",false,false,"ToneMatch Korean color analysis: Summer Cool. Recommended for soft cool and muted clothing colors.","ToneMatch: Summer Cool");
        baseIfMissing(repo,"Autumn Warm Olive Overshirt",ProductCategory.FASHION,529,seller,"/img/tryon/men-long-sleeve.svg",false,false,"ToneMatch Korean color analysis: Autumn Warm. Best for olive, camel, terracotta, mustard, and chocolate brown.","ToneMatch: Autumn Warm");
        baseIfMissing(repo,"Autumn Warm Camel Pants",ProductCategory.FASHION,599,seller,"/img/tryon/men-chino-pants.svg",false,false,"ToneMatch Korean color analysis: Autumn Warm. Recommended for earthy warm clothing palettes.","ToneMatch: Autumn Warm");
        baseIfMissing(repo,"Winter Cool Black Blazer",ProductCategory.FASHION,799,seller,"/img/tryon/women-office-blazer.svg",false,false,"ToneMatch Korean color analysis: Winter Cool. Best for black, white, navy, royal blue, burgundy, and high contrast colors.","ToneMatch: Winter Cool");
        baseIfMissing(repo,"Winter Cool Navy Dress",ProductCategory.FASHION,699,seller,"/img/tryon/women-dress-navy.png",false,false,"ToneMatch Korean color analysis: Winter Cool. Recommended for sharp cool and high-contrast fashion colors.","ToneMatch: Winter Cool");
    }
    ...
    private void setProductImage(ProductRepository repo, String productName, String imageUrl) {
        repo.findByNameIgnoreCase(productName).ifPresent(product -> {
            ...
            product.setPhotoAltText(productName + " demo product photo");
            repo.save(product);
        });
    }
