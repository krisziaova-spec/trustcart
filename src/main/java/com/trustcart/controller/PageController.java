...
public class PageController {
    ...
    public void sitemapXml(HttpServletResponse response) throws IOException {
        ...
        String[] paths = {"/","/seller","/seller/apply","/buyer/login","/buyer/register","/registry","/registry/create","/try-on","/autoship","/track","/refund","/faq","/buyer/faq","/site-map","/privacy-policy","/terms-and-conditions","/return-refund-policy","/shipping-delivery-policy","/payment-policy","/buyer-protection-policy","/seller-policy","/authenticity-policy","/sustainability-policy","/prohibited-items-policy","/off-platform-policy"};
