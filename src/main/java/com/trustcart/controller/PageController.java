...
public class PageController {
    ...
    public void sitemapXml(HttpServletResponse response) throws IOException {
        ...
        String[] paths = {"/","/seller","/seller/apply","/buyer/login","/buyer/register","/registry","/registry/create","/try-on","/autoship","/track","/refund","/faq","/site-map","/privacy-policy","/terms-and-conditions","/return-refund-policy","/shipping-delivery-policy","/payment-policy","/buyer-protection-policy","/seller-policy","/authenticity-policy","/sustainability-policy","/prohibited-items-policy","/off-platform-policy"};
    ...
    public String faq(Model model) {
        ...
        model.addAttribute("content", "TrustCart answers buyer and seller questions about verified sellers, WELCOME10, TrustPoints, autoshipment, live selling, Gift Registry, Virtual Try-On Preview, refunds, and protected checkout.");
        return "simple-page";
    }
    ...
    public String siteMap(Model model) {
        ...
        links.put("Gift Registry", "/registry");
        links.put("Create Gift Registry", "/registry/create");
