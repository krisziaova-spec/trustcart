...
public class SellerController {
    ...
    public String sellerReply(@PathVariable Long threadId, @RequestParam String message,
        ...
        saveChatMessage(thread, "SELLER", seller.getStoreName(), seller.getEmail(), message);
    ...
    private void saveChatMessage(ChatThread thread, String role, String name, String email, String message) {
