...
public class CustomerOrder {
    ...
    private String escrowStatus = "TRUSTCART_PROTECTED";
    private String paymentReference;
    private String orderStatus = "PLACED";
    private String trackingStage = "Order Placed";
    private String trackingNote = "Your order is protected by TrustCart.";
