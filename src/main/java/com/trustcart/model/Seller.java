...
public class Seller {
    ...
    private String riskStatus = "GOOD_STANDING"; // GOOD_STANDING, UNDER_REVIEW, VERIFICATION_REQUIRED, RESTRICTED
    @Column(length = 1500)
    ...
    public String getRiskStatus() { return riskStatus == null || riskStatus.isBlank() ? "GOOD_STANDING" : riskStatus; }
    ...
    public LocalDateTime getWarningSentAt() { return warningSentAt; }
    public void setWarningSentAt(LocalDateTime warningSentAt) { this.warningSentAt = warningSentAt; }
